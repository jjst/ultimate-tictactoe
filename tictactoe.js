...
var _user$project$Player$O = {ctor: 'O'};
var _user$project$Player$X = {ctor: 'X'};
var _user$project$Player$opponent = function (player) {
	var _p0 = player;
	if (_p0.ctor === 'X') {
		return _user$project$Player$O;
	} else {
		return _user$project$Player$X;
	}
};
var _user$project$Player$Right = function (a) {
	return {ctor: 'Right', _0: a};
};
var _user$project$Player$Left = function (a) {
	return {ctor: 'Left', _0: a};
};
var _user$project$Player$Draw = {ctor: 'Draw'};

var _user$project$Tuple3$fromList = function (l) {
	var _p0 = l;
...
var _user$project$Tuple3$toList = function (_p1) {
	var _p2 = _p1;
	return {
		ctor: '::',
		_0: _p2._0,
...
var _user$project$Tuple3$fill = function (item) {
	return {ctor: '_Tuple3', _0: item, _1: item, _2: item};
};
var _user$project$Tuple3$map = F2(
	function (f, _p3) {
		var _p4 = _p3;
		return {
			ctor: '_Tuple3',
...
var _user$project$Tuple3$third = function (_p5) {
	var _p6 = _p5;
	return _p6._2;
};
var _user$project$Tuple3$last = _user$project$Tuple3$third;
var _user$project$Tuple3$second = function (_p7) {
	var _p8 = _p7;
	return _p8._1;
};
var _user$project$Tuple3$first = function (_p9) {
	var _p10 = _p9;
	return _p10._0;
};
var _user$project$Tuple3$toInt = function (index) {
	var _p11 = index;
	switch (_p11.ctor) {
		case 'I1':
			return 0;
...
var _user$project$Tuple3$toFloat = function (index) {
	return _elm_lang$core$Basics$toFloat(
		_user$project$Tuple3$toInt(index));
};
var _user$project$Tuple3$get = F2(
	function (_p12, idx) {
		var _p13 = _p12;
		var _p14 = idx;
		switch (_p14.ctor) {
...
var _user$project$Tuple3_ops = _user$project$Tuple3_ops || {};
_user$project$Tuple3_ops['!!'] = F2(
	function (tuple, idx) {
		return A2(_user$project$Tuple3$get, tuple, idx);
	});
var _user$project$Tuple3$I3 = {ctor: 'I3'};
var _user$project$Tuple3$I2 = {ctor: 'I2'};
var _user$project$Tuple3$I1 = {ctor: 'I1'};
var _user$project$Tuple3$range = {ctor: '_Tuple3', _0: _user$project$Tuple3$I1, _1: _user$project$Tuple3$I2, _2: _user$project$Tuple3$I3};
var _user$project$Tuple3$indexedMap = F2(
	function (f, _p15) {
		var _p16 = _p15;
		return {
			ctor: '_Tuple3',
			_0: A2(f, _user$project$Tuple3$I1, _p16._0),
			_1: A2(f, _user$project$Tuple3$I2, _p16._1),
			_2: A2(f, _user$project$Tuple3$I3, _p16._2)
		};
	});

var _user$project$Board$get = F2(
	function (board, _p0) {
		var _p1 = _p0;
		return A2(
			_user$project$Tuple3_ops['!!'],
			A2(_user$project$Tuple3_ops['!!'], board, _p1._0),
			_p1._1);
	});
var _user$project$Board$isWinningRow = F3(
	function (owner, board, row) {
		var owners = _user$project$Tuple3$toList(
			A2(
				_user$project$Tuple3$map,
				function (coords) {
					return owner(
						A2(_user$project$Board$get, board, coords));
				},
				row));
		return A2(
...
var _user$project$Board$flatten = function (board) {
	return _elm_lang$core$List$concat(
		_user$project$Tuple3$toList(
			A2(_user$project$Tuple3$map, _user$project$Tuple3$toList, board)));
};
var _user$project$Board$allRows = function () {
	var diagonals = {
		ctor: '::',
		_0: {
			ctor: '_Tuple3',
			_0: {ctor: '_Tuple2', _0: _user$project$Tuple3$I1, _1: _user$project$Tuple3$I1},
			_1: {ctor: '_Tuple2', _0: _user$project$Tuple3$I2, _1: _user$project$Tuple3$I2},
			_2: {ctor: '_Tuple2', _0: _user$project$Tuple3$I3, _1: _user$project$Tuple3$I3}
		},
		_1: {
			ctor: '::',
			_0: {
				ctor: '_Tuple3',
				_0: {ctor: '_Tuple2', _0: _user$project$Tuple3$I1, _1: _user$project$Tuple3$I3},
				_1: {ctor: '_Tuple2', _0: _user$project$Tuple3$I2, _1: _user$project$Tuple3$I2},
				_2: {ctor: '_Tuple2', _0: _user$project$Tuple3$I3, _1: _user$project$Tuple3$I1}
			},
			_1: {ctor: '[]'}
		}
	};
	var range = _user$project$Tuple3$range;
	var horizontals = _user$project$Tuple3$toList(
		A2(
			_user$project$Tuple3$map,
			function (y) {
				return A2(
			...
			range));
	var verticals = _user$project$Tuple3$toList(
		A2(
			_user$project$Tuple3$map,
			function (y) {
				return A2(
...
var _user$project$Board$winningRow = F2(
	function (owner, board) {
		return _elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
				function (r) {
					return A3(_user$project$Board$isWinningRow, owner, board, r);
				},
				_user$project$Board$allRows));
	});
var _user$project$Board$winner = F2(
	function (owner, board) {
		var _p2 = A2(_user$project$Board$winningRow, owner, board);
		if ((_p2.ctor === 'Just') && (_p2._0.ctor === '_Tuple3')) {
			return A2(
				_elm_lang$core$Maybe$map,
				_user$project$Player$Left,
				owner(
					A2(_user$project$Board$get, board, _p2._0._0)));
		} else {
			var hasEmptyCells = A2(
				...
				_user$project$Board$flatten(board));
			return hasEmptyCells ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(
				_user$project$Player$Right(_user$project$Player$Draw));
		}
	});
var _user$project$Board$indexedMap = F2(
	function (f, mat3) {
		return A2(
			_user$project$Tuple3$indexedMap,
			F2(
				function (i, row) {
					return A2(
						_user$project$Tuple3$indexedMap,
...
var _user$project$Cell$drawCross = A2(
	_elm_lang$svg$Svg$g,
	{
		ctor: '::',
...
var _user$project$Cell$drawCircle = A2(
...
var _user$project$SvgUtils$scale = F2(
	function (x, elt) {
		...
		return A2(_user$project$SvgUtils$applyTransform, transform, elt);
	});
var _user$project$SvgUtils$translate = F3(
	function (x, y, elt) {
		var transform = A2(
			_elm_lang$core$Basics_ops['++'],
			'translate(',
...
var _user$project$TicTacToeBase$cellSize = 220;
var _user$project$TicTacToeBase$boardSize = _user$project$TicTacToeBase$cellSize * 3;
var _user$project$TicTacToeBase$gridStyle = _elm_lang$svg$Svg_Attributes$style('stroke:black;stroke-width:4');
var _user$project$TicTacToeBase$strikeThrough = F4(
		...
		var toSvgCoords = F2(
			function (x, offset) {
				return _elm_lang$core$Basics$toString(
					((_user$project$Tuple3$toFloat(x) + 0.5) + offset) * _elm_lang$core$Basics$toFloat(cellSize));
			});
		return A2(
			_elm_lang$svg$Svg$line,
			{
...
var _user$project$TicTacToeBase$grid = function (cellSize) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$TicTacToeBase$gridStyle,
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$TicTacToeBase$svgView = F3(
	function (owner, svgViewCell, model) {
		...
		var st = function () {
			var _p4 = {
				ctor: '_Tuple2',
				_0: A2(_user$project$Board$winningRow, owner, board),
				_1: A2(_user$project$Board$winner, owner, board)
			};
			if ((((_p4.ctor === '_Tuple2') && (_p4._0.ctor === 'Just')) && (_p4._0._0.ctor === '_Tuple3')) && (_p4._1.ctor === 'Just')) {
				...
				if (_p5.ctor === 'Left') {
					if (_p5._0.ctor === 'O') {
						return {
							ctor: '::',
							_0: A4(_user$project$TicTacToeBase$strikeThrough, 'red', _user$project$TicTacToeBase$cellSize, _p6, _p7),
							_1: {ctor: '[]'}
						};
					} else {
						return {
							ctor: '::',
							_0: A4(_user$project$TicTacToeBase$strikeThrough, 'blue', _user$project$TicTacToeBase$cellSize, _p6, _p7),
							_1: {ctor: '[]'}
						};
					}
				} else {
...
var _user$project$UltimateTicTacToe$fromString = F3(
...
var _user$project$UltimateTicTacToe$init = {
	board: _user$project$Tuple3$fill(
		_user$project$Tuple3$fill(_user$project$TicTacToe$init)),
	currentPlayer: _user$project$Player$X,
	currentBoardCoords: _elm_lang$core$Maybe$Nothing
};
var _user$project$UltimateTicTacToe$Model = F3(
	function (a, b, c) {
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$UltimateTicTacToe$svgView(model),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
...
var _user$project$Menu$view = function (model) {
	...
	if (_p1.ctor === 'NotChosen') {
		return A2(
			...
			{
				ctor: '::',
				_0: _user$project$Menu$pageContent,
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$Menu$Choose1P),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_user$project$Menu$Choose2P),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
...
var _user$project$Main$NewWindowSize = function (a) {
	return {ctor: 'NewWindowSize', _0: a};
};
var _user$project$Main$getWindowSize = A2(_elm_lang$core$Task$perform, _user$project$Main$NewWindowSize, _elm_lang$window$Window$size);
var _user$project$Main$init = function () {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Main$getWindowSize,
			_1: {ctor: '[]'}
		});
}();
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _elm_lang$window$Window$resizes(_user$project$Main$NewWindowSize),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$Main$view = function (_p6) {
	...
	var baseBoardSize = _elm_lang$core$Basics$toFloat(_user$project$TicTacToeBase$boardSize);
	var scale = minSize / baseBoardSize;
	var svgView = A2(
		_elm_lang$html$Html$map,
		_user$project$Main$TicTacToeMessage,
		A2(
			_user$project$SvgUtils$scale,
			scale,
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Main$css('style.css'),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$svg$Svg$svg,
